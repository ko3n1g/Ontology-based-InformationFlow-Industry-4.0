...
public class SMDPostInspectionProcessStep extends ProcessStep {

    public SMDPostInspectionProcessStep(OWLOntologyManager manager) throws OWLOntologyCreationException {
        super(manager);
    }
    ...
    public OWLNamedIndividual create(Integer processStepId, List<IRI> inputs, List<IRI> outputs, IRI sensor) throws OWLOntologyCreationException, OWLOntologyStorageException {
        ...
        OWLNamedIndividual task1 = tasks.addAoiPostInspectionTask(manager, inputs, outputs, sensor);
